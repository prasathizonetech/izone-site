...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="container-custom flex w-full max-w-full items-center justify-between gap-3 px-4 lg:px-8">
        {/* Logo */}
        <Link to="/" className="flex min-w-0 items-center gap-3 group">
          <img
            src="/izone-logo.png"
            alt="iZone"
            className="h-10 w-auto max-w-[120px] rounded-md object-contain transition-transform duration-200 group-hover:scale-[1.02] min-[380px]:max-w-[138px] min-[769px]:h-12"
          />
        </Link>
