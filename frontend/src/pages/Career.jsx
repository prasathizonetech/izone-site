              ...
              <form onSubmit={handleSubmit} className="space-y-6 py-2">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="fullName" placeholder="Enter Your Name" required className="bg-background/50 border-primary/10" value={formData.fullName} onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium">Email ID</label>
                    <Input id="email" type="email" placeholder="Enter Your Email" required className="bg-background/50 border-primary/10" value={formData.email} onChange={handleInputChange} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="mobile" type="tel" placeholder="Enter 10 -Digit number" required maxLength={10} className="bg-background/50 border-primary/10" value={formData.mobile} onChange={handleInputChange} />
                  </div>
                  <div className="space-y-2">
              ...
              <form onSubmit={handleInternSubmit} className="space-y-6 py-2">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="internFullName" placeholder="Enter Your Name" required className="bg-background/50 border-primary/10" value={internFormData.fullName} onChange={(e) => setInternFormData((prev) => ({ ...prev, fullName: e.target.value }))} />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="internEmail" className="text-sm font-medium">Email ID</label>
                    <Input id="internEmail" type="email" placeholder="Enter Your Email" required className="bg-background/50 border-primary/10" value={internFormData.email} onChange={(e) => setInternFormData((prev) => ({ ...prev, email: e.target.value }))} />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="internMobile" type="tel" placeholder="Enter 10 -Digit number" required maxLength={10} className="bg-background/50 border-primary/10" value={internFormData.mobile} onChange={(e) => setInternFormData((prev) => ({ ...prev, mobile: e.target.value }))} />
                  </div>
                  <div className="space-y-2">
