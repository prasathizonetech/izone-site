            ...
            <form onSubmit={handleSubmit} className="space-y-6 py-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="mobile" type="tel" placeholder="Enter 10 -Digit number" required pattern="[0-9]{10}" maxLength={10} title="Enter a valid 10-digit mobile number" className="bg-background/50 border-primary/10" value={formData.mobile} onChange={handleInputChange} />
                </div>
                <div className="space-y-2">
