...
const Index = () => {
  ...
  return (
    <Layout>
      <AdminPopup />
      <section className="relative overflow-hidden bg-[#e1e8e2] px-4 pt-12 dark:bg-background md:px-8 md:pt-20 xl:min-h-screen">
        ...
        <motion.div
          ...
          className="container-custom relative z-10 flex min-h-[calc(100vh-4rem)] w-full max-w-full min-w-0 items-start pb-6 pt-2 md:min-h-[calc(100vh-7rem)] md:pb-12 md:pt-4 xl:min-h-screen xl:items-center xl:py-20"
        >
          <div className="grid w-full max-w-full min-w-0 items-center justify-items-center gap-8 pt-0 md:pt-8 lg:grid-cols-2 lg:gap-12 xl:gap-16 xl:pt-0">
            ...
            <motion.div
              ...
              className="relative w-full flex justify-center lg:hidden overflow-x-hidden"
              style={{ height: 400 }}
            >
              <div
                style={{
            ...
            >
              <div className="relative w-full flex items-center justify-center lg:justify-center xl:justify-end xl:-mr-8 [isolation:isolate]">
                <HeroVisualCard />
              </div>
            </motion.div>
          </div>
