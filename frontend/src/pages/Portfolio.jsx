...
const projects = [
...

  {
    ...
    client: 'Academy for Dental Students.',
  },
   ...
   
  {
    title: 'Zen Tonez',
    category: 'Full Stack',
    description: 'We provide complete beauty and grooming services with a focus on quality, hygiene, and customer satisfaction. Our services include bridal makeup, hairstyling, skincare, facials, threading, manicure, pedicure, and spa treatments. With experienced professionals and modern techniques, we help clients look confident and feel refreshed .',
    image: '/portfolio/zen.png',
    tags: ['React','Type Scripts', 'Fast API', 'PostgreSQL'],
    client: 'Beauty Salon',
  },
